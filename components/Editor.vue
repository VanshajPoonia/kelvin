<template>
  <div :class="['editor-area', getEditorMode]">
    ...
    <div
      ...
      "
    >
      <h2 class="title">Welcome to Kelvin</h2>
      <p class="description">
        Kelvin is an in-browser snippet manager and editor.
      </p>
      ...
      <ul class="menu">
        <li>
          <a
            href="https://github.com/VanshajPoonia/kelvin"
            target="_blank"
        ...
        <li>
          <a
            href="https://github.com/VanshajPoonia/kelvin/issues"
            target="_blank"
            ref="noopener noreferrer"
